...
const GenerateIncomeReport = () => {
    ...
    const generateIncomeReport = async () => {
        ...
        console.log(endDate)
        try {
            const response = await axios.get(API_URLS_CONFIG.BASE_URL + '/api/report/period/income', {
                method: "GET",
                            ...
                            <div className="flex max-w-md max-auto">
                                <div className="py-2">
                                    ...
                                    <div className="h-14 my-4 space-x-4 pt-4">
                                        <button onClick={generateIncomeReport}
